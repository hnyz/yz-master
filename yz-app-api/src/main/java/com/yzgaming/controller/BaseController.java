...
public abstract class BaseController {
    ...
    protected static final ThreadLocal<UserInfoVO> currentLoginUser = new ThreadLocal<UserInfoVO>();
    /**
     * 日志logger
     */
	 ...
	 * @return
	 */
	public static UserInfoVO getLoginUser(HttpServletRequest request) {
        try{
			UserInfoVO userVo = _getLoginUser(request);
            return userVo;
        } catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    private static UserInfoVO _getLoginUser(HttpServletRequest request) {
		UserInfoVO userVo = currentLoginUser.get();
    ...
    //
    public void saveSessionUser(UserInfoVO userVo){
