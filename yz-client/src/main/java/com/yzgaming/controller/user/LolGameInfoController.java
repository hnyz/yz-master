 ...
 */
@Controller
@RequestMapping("/user/lolGameInfo")
public class LolGameInfoController  {
...
//		//
//		Integer count = lolGameInfoService.countBy(params);
//		List<LolGameInfo> lolGameInfoList = lolGameInfoService.listPage(params);
//		//
//		JSONMessage jsonMessage = JSONMessage.successMessage();
//		jsonMessage.setTotal(count);
//		jsonMessage.setData(lolGameInfoList);
//
//		return jsonMessage;
//	}
//
...
//		Map<String, Object> params = parseParamMapObject(request);
//		//
//		LolGameInfo lolGameInfo = new LolGameInfo();
//		//
//		map2Bean(params, lolGameInfo);
//		//
//
//		//
//		JSONMessage jsonMessage = JSONMessage.failureMessage();
//        try{
//			Integer rows = lolGameInfoService.add(lolGameInfo);
//            if(rows > 0){
...
//		JSONMessage jsonMessage = JSONMessage.failureMessage();
//        try{
//			Integer rows = lolGameInfoService.update(lolGameInfo);
//            if(rows > 0){
//                jsonMessage = JSONMessage.successMessage();
//            }
//        } catch(Exception ex){
...
//		JSONMessage jsonMessage = JSONMessage.failureMessage();
//        try{
//			Integer rows = lolGameInfoService.delete(id);
//            if(rows > 0){
//                jsonMessage = JSONMessage.successMessage();
//            }
//        } catch(Exception ex){
